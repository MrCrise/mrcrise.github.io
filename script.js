...
DG.then(function () {
    ...
    const loadData = {
        "понедельник": [2, 40, 50, 60, 70, 80, 90, 60, 40, 20, 2],
        "вторник": [2, 30, 50, 70, 60, 50, 40, 80, 90, 30, 2],
        "среда": [2, 25, 45, 65, 55, 45, 35, 75, 85, 25, 2],
        "четверг": [2, 45, 55, 75, 65, 55, 45, 85, 95, 35, 2],
        "пятница": [2, 55, 65, 85, 75, 65, 55, 95, 100, 45, 2],
        "суббота": [2, 60, 70, 90, 80, 70, 60, 100, 90, 50, 2],
        "воскресенье": [2, 50, 60, 80, 70, 60, 50, 90, 80, 40, 2]
    };
